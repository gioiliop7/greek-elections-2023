...
export default function Summary({
  ...
  const partyElements = parties.map((party) => {
    ...
    return (
      <div
        className="w-[60%] sm:w-2/6 sm:px-4 sm:py-3 h-[200px] lg:h-[150px] flex justify-center flex-col text-center rounded-xl bg-white"
        key={party.id}
      >
    ...
    <>
      ...
      <div className="container mx-auto md:px-8 py-10 md:py-0">
        ...
        <div className="flex gap-5 justify-center flex-wrap px-10 sm:px-0">
          {partyElements}
          <div className="w-[60%] sm:w-2/6 px-4 py-3  h-[200px] lg:h-[150px] flex justify-center flex-col text-center  rounded-xl bg-white">
